...
The recovery integration is based on current `main` commit `d6ab3a4f3dc1ce4f3eda6fcabaaeaa28f7862e17` and is implemented on branch `m1-20260630` without rewriting the historical PR #45 branch.
...
6. Independent review of the exact recovery head.
...
- Work occurs only on `m1-20260630`, based on current `main` commit `d6ab3a4f3dc1ce4f3eda6fcabaaeaa28f7862e17`.
- Historical PR #45 and its branch remain unchanged.
- A replacement draft PR may be opened for CI evidence and exact-head review.
